    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600"
        >
          <FaPlus /> Add Category
        </button>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative w-full sm:w-64">
          ...
          <input
            className="pl-10 pr-4 py-2 w-full rounded-lg bg-gray-100 focus:ring-2 focus:ring-yellow-400"
        ...
        <select
          className="px-4 py-2 rounded-lg bg-gray-100 w-full sm:w-40"
          value={statusFilter}
